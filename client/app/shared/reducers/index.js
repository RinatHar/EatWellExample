...
export const reducers = combineReducers({
  ...
  dailyRations: require('../../modules/entities/daily-ration/daily-ration.reducer').reducer,
  userProperties: require('../../modules/entities/user-properties/user-properties.reducer').reducer,
