...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERPROPERTIES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERPROPERTIES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERPROPERTIES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERPROPERTIES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERPROPERTIES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERPROPERTIES actions', async () => {
      const arg = 42666;
