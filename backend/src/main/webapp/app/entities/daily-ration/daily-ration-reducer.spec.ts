...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DAILYRATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DAILYRATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DAILYRATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DAILYRATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DAILYRATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DAILYRATION actions', async () => {
      const arg = 42666;
