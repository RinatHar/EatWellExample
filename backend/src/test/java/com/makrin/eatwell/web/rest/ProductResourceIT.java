...
import static com.makrin.eatwell.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    private static final Double DEFAULT_FATS = 1D;
    private static final Double UPDATED_FATS = 2D;
    ...
    @Test
    @Transactional
    void checkProteinIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        product.setProtein(null);
    ...
    @Test
    @Transactional
    void checkFatsIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.createdDate(UPDATED_CREATED_DATE);
